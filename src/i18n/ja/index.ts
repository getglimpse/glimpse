...
const ja = {
  ...
  pluginPage: {
    ...
    remote: {
      ...
      readmeLoadError: "README を読み込めませんでした。",
      readmeTooLarge: "README が大きすぎるため表示できません。",
      api: "API",
      release: "リリース",
      ...
      enableFailed: "有効化に失敗しました: {error}",
      disableFailed: "無効化に失敗しました: {error}",
    ...
    installed: {
      ...
      replace: "置き換え",
      localInstall: "ローカル plugin をインストール",
      install: "インストール",
      installing: "インストール中",
      openFolder: "フォルダを開く",
      installSuccess:
