...
const ja = {
  ...
  pluginPage: {
    ...
    remote: {
      registry: "公式プラグイン registry",
      refresh: "registry を再読み込み",
      loadError: "リモートプラグインの読み込みに失敗しました: {error}",
      empty: "リモートプラグインは見つかりませんでした。",
      noSearchResults: "一致するリモートプラグインはありません。",
      install: "インストール",
      update: "更新",
      installed: "インストール済み",
      unsupported: "非対応",
